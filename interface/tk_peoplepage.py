...
class PeoplePage(Frame):
    def __init__(self, parent, controller):
        ...
        # Content
        content_label = Label(
            self, text="This is the People Page.", bg="#333333", fg="#BDFDC0", font=("Arial", 16), justify="center"
        )
        ...
        add_button = Button(
            ...
            width=7,
            relief="flat",
            command=lambda: controller.show_frame("Add_People")
        )
